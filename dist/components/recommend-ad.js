...
var RecommendAd = (_temp2 = _class = function (_BaseComponent) {
  ...
  _createClass(RecommendAd, [{
    ...
    value: function _createCode2Data(_$uid) {
      ...
      return function (data, key) {
        var loopArray35 = data.map(function (item, __index1) {
          item = {
            $original: (0, _taroWeapp.internal_get_original)(item)
          };

          var _$indexKey = "dizzz" + __index1;
    ...
    value: function _createData() {
      ...
      if (formatCode === '2' || formatCode === '6') {
        ...
        _$_$anonymousState__temp = this._createCode2Data(__prefix + "djzzzzzzzz")(datas, key);
      } else if (formatCode === '3') {
        _$_$anonymousState__temp2 = undefined;
        _$_$anonymousState__temp2 = this._createCode3Data(__prefix + "eazzzzzzzz")(datas, key);
      } else if (formatCode === '4') {
        _$_$anonymousState__temp3 = undefined;
        _$_$anonymousState__temp3 = this._createCode4Data(__prefix + "ebzzzzzzzz")(datas, key);
      } else if (formatCode === '5') {
        _$_$anonymousState__temp4 = undefined;
        _$_$anonymousState__temp4 = this._createCode5Data(__prefix + "eczzzzzzzz")(datas, key);
      } else if (formatCode === '7') {
        _$_$anonymousState__temp5 = undefined;
        _$_$anonymousState__temp5 = this._createCode7Data(__prefix + "edzzzzzzzz")(datas, key);
      }

      var anonymousState__temp6 = this._createCode1Data(__prefix + "eezzzzzzzz")(datas, key);
    ...
    value: function _createCode7Data(_$uid) {
      ...
      return function (data, key) {
        var loopArray36 = data.map(function (item, __index12) {
          item = {
            $original: (0, _taroWeapp.internal_get_original)(item)
          };

          var _$indexKey2 = "efzzz" + __index12;
