...
var OrderAdd = (_temp2 = _class = function (_BaseComponent) {
  ...
  function OrderAdd() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = OrderAdd.__proto__ || Object.getPrototypeOf(OrderAdd)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp3", "loopArray411", "addressLists", "defaultId", "fromPage", "appStore"], _this.config = {
  ...
  _createClass(OrderAdd, [{
    ...
    value: function _createData() {
      ...
      var loopArray411 = this.__state.addressLists.length > 0 ? this.__state.addressLists.map(function (item, index) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };

        var _$indexKey = "ciczz" + index;
