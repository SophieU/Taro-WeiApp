...
var Admin = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Admin() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Admin.__proto__ || Object.getPrototypeOf(Admin)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp3", "loopArray62", "$compid__83", "$compid__84", "$compid__85", "currentTab", "orderLists", "cancelReasonLists", "pageNo", "pageSize", "hasNextPage", "reasonModal", "cancelReasonId", "showRefresh", "nowItem"], _this.config = {
  ...
  _createClass(Admin, [{
    ...
    value: function _createData() {
      ...
      var loopArray62 = this.__state.orderLists.map(function (item, __index0) {
        ...
        var $loopState__temp2 = _this3._createFootBtnData(__prefix + "gjzzzzzzzz" + ('' + __index0))(item.$original);
