...
var Admin = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Admin() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Admin.__proto__ || Object.getPrototypeOf(Admin)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp3", "loopArray63", "$compid__87", "$compid__88", "$compid__89", "currentTab", "orderLists", "cancelReasonLists", "pageNo", "pageSize", "hasNextPage", "reasonModal", "cancelReasonId", "showRefresh", "nowItem"], _this.config = {
  ...
  _createClass(Admin, [{
    ...
    value: function _createData() {
      ...
      var loopArray63 = this.__state.orderLists.map(function (item, __index0) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };

        var $loopState__temp2 = _this3._createFootBtnData(__prefix + "hazzzzzzzz" + ('' + __index0))(item.$original);
