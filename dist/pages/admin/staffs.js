...
var Lists = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Lists() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Lists.__proto__ || Object.getPrototypeOf(Lists)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__62", "$compid__63", "choosed", "orderId", "lists", "type", "stationName"], _this.config = {
