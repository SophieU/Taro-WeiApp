...
var Lists = (_temp2 = _class = function (_BaseComponent) {
  ...
  _createClass(Lists, [{
    ...
    value: function _createData() {
      ...
      var loopArray66 = this.__state.commentOptions.map(function (item, index) {
        item = {
      ...
      var loopArray67 = this.__state.commentDetail.map(function (item, index) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };
