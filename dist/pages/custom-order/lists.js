...
var Lists = (_temp2 = _class = function (_BaseComponent) {
  ...
  _createClass(Lists, [{
    ...
    value: function _createData() {
      ...
      var anonymousState__temp = this._createListItemData(__prefix + "fizzzzzzzz")(this.__state.lists['STAY_RECEIPT']);

      var anonymousState__temp2 = this._createListItemData(__prefix + "fjzzzzzzzz")(this.__state.lists['STAY_PAY']);

      var anonymousState__temp3 = this._createListItemData(__prefix + "gazzzzzzzz")(this.__state.lists['STAY_COMMENT']);

      var anonymousState__temp4 = this._createListItemData(__prefix + "gbzzzzzzzz")(this.__state.lists['FINISH']);
    ...
    value: function _createListItemData(_$uid) {
      return function (lists) {
        var loopArray48 = lists.length > 0 ? lists.map(function (item, index) {
          item = {
            $original: (0, _taroWeapp.internal_get_original)(item)
          };

          var _genCompid11 = (0, _taroWeapp.genCompid)(_$uid + 'gczzzzzzzz' + index, true),
              _genCompid12 = _slicedToArray(_genCompid11, 2),
              $prevCompid__64 = _genCompid12[0],
              $compid__64 = _genCompid12[1];
