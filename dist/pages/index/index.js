...
var Index = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray35", "loopArray36", "loopArray37", "loopArray38", "hideService", "configApiVoList", "serviceList", "adBannerList", "serviceBlockLists", "pageNo", "pageSize", "hasNextPage"], _this.config = {
  ...
  _createClass(Index, [{
    ...
    value: function _createData() {
      ...
      var loopArray35 = this.__state.adBannerList.map(function (item, index) {
        item = {
      ...
      var loopArray36 = this.__state.serviceList.map(function (item, __index1) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };

        var _$indexKey2 = "eazzz" + __index1;
      ...
      var loopArray37 = this.__state.configApiVoList.map(function (item, _anonIdx) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };

        var _genCompid = (0, _taroWeapp.genCompid)(__prefix + "eczzzzzzzz" + _anonIdx, true),
      ...
      var loopArray38 = this.__state.serviceBlockLists.map(function (item, index) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };
        var $anonymousCallee__5 = item.$original.categoryList.map(function (child, __index2) {
          ...
          var _$indexKey3 = "ebzzz" + index + "-" + __index2;
