...
var Index = (_temp2 = _class = function (_BaseComponent) {
  ...
  _createClass(Index, [{
    ...
    value: function _createData() {
      ...
      var loopArray393 = this.__state.adBannerList.map(function (item, index) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };

        var _$indexKey = "cggzz" + index;
      ...
      var loopArray394 = this.__state.serviceList.map(function (item, __index1) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };

        var _$indexKey2 = "cghzz" + __index1;
      ...
      var loopArray395 = this.__state.configApiVoList.map(function (item, _anonIdx) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };

        var _genCompid = (0, _taroWeapp.genCompid)(__prefix + "cgjzzzzzzz" + _anonIdx, true),
            _genCompid2 = _slicedToArray(_genCompid, 2),
            $prevCompid__586 = _genCompid2[0],
            $compid__586 = _genCompid2[1];

        _taroWeapp.propsManager.set({
          "source": item.$original
        }, $compid__586, $prevCompid__586);
        return {
          $compid__586: $compid__586,
          $original: item.$original
        };
      });

      var loopArray396 = this.__state.serviceBlockLists.map(function (item, index) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };
        var $anonymousCallee__22 = item.$original.categoryList.map(function (child, __index2) {
          child = {
            $original: (0, _taroWeapp.internal_get_original)(child)
          };
          var _$indexKey3 = "cgizz" + index + "-" + __index2;

          _this2.anonymousFunc2Map[_$indexKey3] = function () {
            _this2.jumpTo(child.$original, 'E_SERVICE_CATEGORY');
          };
      ...
      Object.assign(this.__state, {
        loopArray393: loopArray393,
        loopArray394: loopArray394,
        loopArray395: loopArray395,
