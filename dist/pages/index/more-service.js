...
var More = (_temp2 = _class = function (_BaseComponent) {
  ...
  function More() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = More.__proto__ || Object.getPrototypeOf(More)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "loopArray379", "loopArray380", "serviceLists", "currentTab", "scrollTop", "scrollIntoView", "scrollPadding", "scrollNavIntoView", "scrollIntoNavView"], _this.config = {
  ...
  _createClass(More, [{
    ...
    value: function _createData() {
      ...
      var loopArray379 = this.__state.scrollPadding === '40px' ? this.__state.serviceLists.map(function (item, index) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };

        var _$indexKey = "cfczz" + index;
      ...
      var loopArray380 = this.__state.serviceLists.map(function (item, index) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };
        var $anonymousCallee__18 = item.$original.categoryList.map(function (child, __index2) {
          child = {
            $original: (0, _taroWeapp.internal_get_original)(child)
          };
          var _$indexKey2 = 'cfdzz' + index + '-' + __index2;
