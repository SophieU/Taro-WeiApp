...
var OrderListsCustom = (_temp2 = _class = function (_BaseComponent) {
  ...
  function OrderListsCustom() {
    ...
    return _ret = (_temp = (_this2 = _possibleConstructorReturn(this, (_ref = OrderListsCustom.__proto__ || Object.getPrototypeOf(OrderListsCustom)).call.apply(_ref, [this].concat(args))), _this2), _this2.$usedState = ["loopArray47", "pageNo", "pageSize", "hasNextPage", "lists"], _this2.config = {
      ...
      (0, _orderApi.getWxPay)(params).then(function (res) {
        ...
        if (res.data.code === 0) {
          ...
          _taroWeapp2.default.showToast({ title: res.data.msg });
        }
      });
  ...
  _createClass(OrderListsCustom, [{
    ...
    value: function _createData() {
      ...
      var loopArray47 = this.__state.lists.map(function (item, __index0) {
        item = {
