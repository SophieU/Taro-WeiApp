...
var OrderListsStaff = /** @class */function () {
  var _class, _temp2;
  ...
  var OrderListsStaff = (_temp2 = _class = function (_BaseComponent) {
    ...
    function OrderListsStaff() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = OrderListsStaff.__proto__ || Object.getPrototypeOf(OrderListsStaff)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "loopArray61", "$compid__87", "$compid__88", "$compid__89", "$compid__90", "$compid__91", "$compid__92", "$compid__93", "current", "pageNo", "pageSize", "hasNextPage", "lists", "showAction", "id", "showPriceModal", "itemPrice", "currentItem", "countDownPay", "showCountDown", "appStore"], _this.config = {
    ...
    _createClass(OrderListsStaff, [{
      ...
      value: function _createData() {
        ...
        var loopArray61 = this.__state.lists.length > 0 ? this.__state.lists.map(function (item, __index0) {
          item = {
          ...
          var _genCompid15 = (0, _taroWeapp.genCompid)(__prefix + "gdzzzzzzzz" + __index0, true),
              _genCompid16 = _slicedToArray(_genCompid15, 2),
              $prevCompid__86 = _genCompid16[0],
              $compid__86 = _genCompid16[1];
