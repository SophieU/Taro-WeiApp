...
var OrderListsStaff = (_temp2 = _class = function (_BaseComponent) {
  ...
  function OrderListsStaff() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = OrderListsStaff.__proto__ || Object.getPrototypeOf(OrderListsStaff)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "loopArray48", "$compid__58", "$compid__59", "$compid__60", "$compid__61", "current", "pageNo", "pageSize", "hasNextPage", "lists", "showAction", "id", "appStore"], _this.config = {
