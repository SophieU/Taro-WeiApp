...
var Mine = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Mine() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Mine.__proto__ || Object.getPrototypeOf(Mine)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray46", "lists", "hasNextPage", "pageNo", "totalCount"], _this.config = {
  ...
  _createClass(Mine, [{
    ...
    value: function _createListsBlockData(_$uid) {
      ...
      return function (blockInfo) {
        var _genCompid = (0, _taroWeapp.genCompid)(_$uid + "$compid__52"),
    ...
    value: function _createData() {
      ...
      var loopArray46 = this.__state.lists.map(function (item, index) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };

        var $loopState__temp3 = _this3._createListsBlockData(__prefix + "fizzzzzzzz" + ('' + index))(item.$original);
