...
var Mine = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Mine() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Mine.__proto__ || Object.getPrototypeOf(Mine)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray44", "lists", "hasNextPage", "pageNo", "totalCount"], _this.config = {
  ...
  _createClass(Mine, [{
    ...
    value: function _createData() {
      ...
      var loopArray44 = this.__state.lists.map(function (item, index) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };

        var $loopState__temp3 = _this3._createListsBlockData(__prefix + "fezzzzzzzz" + ('' + index))(item.$original);
