...
var Mine = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Mine() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Mine.__proto__ || Object.getPrototypeOf(Mine)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "$compid__617", "$compid__618", "userType", "userInfo", "apiUserInfo", "inviteUserPhone", "showInvitePhoneModal", "userStore"], _this.config = {
  ...
  _createClass(Mine, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroWeapp.genCompid)(__prefix + "$compid__617"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__617 = _genCompid2[0],
          $compid__617 = _genCompid2[1];

      var _genCompid3 = (0, _taroWeapp.genCompid)(__prefix + "$compid__618"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__618 = _genCompid4[0],
          $compid__618 = _genCompid4[1];
      ...
      }, $compid__618, $prevCompid__618);
      Object.assign(this.__state, {
        anonymousState__temp: anonymousState__temp,
        $compid__617: $compid__617,
        $compid__618: $compid__618,
        userType: userType
      });
      return this.__state;
    }
  ...
  return Mine;
}(_taroWeapp.Component), _class.$$events = ["anonymousFunc0", "anonymousFunc1", "anonymousFunc2", "anonymousFunc3", "toggleInvitePhoneModal", "anonymousFunc4", "anonymousFunc5", "anonymousFunc6", "anonymousFunc7", "anonymousFunc8", "setInviteUser"], _class.$$componentPath = "pages/mine/mine", _temp2);
