...
var Mine = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Mine() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Mine.__proto__ || Object.getPrototypeOf(Mine)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "$compid__75", "$compid__76", "$compid__77", "$compid__78", "$compid__79", "$compid__80", "$compid__81", "$compid__82", "withdrawMoney", "withdrawPwdForm", "withdrawPwd", "showModal", "showModalPwd", "wallet", "pageSize", "pageNo", "current", "hasNextPage", "hasNextPageWith", "pageSizeWith", "pageNoWith", "flowLists", "withdrawLists"], _this.config = {
  ...
  _createClass(Mine, [{
    ...
    value: function _createData() {
      ...
      var _genCompid11 = (0, _taroWeapp.genCompid)(__prefix + "$compid__80"),
          _genCompid12 = _slicedToArray(_genCompid11, 2),
          $prevCompid__80 = _genCompid12[0],
          $compid__80 = _genCompid12[1];

      var _genCompid13 = (0, _taroWeapp.genCompid)(__prefix + "$compid__81"),
          _genCompid14 = _slicedToArray(_genCompid13, 2),
          $prevCompid__81 = _genCompid14[0],
          $compid__81 = _genCompid14[1];

      var _genCompid15 = (0, _taroWeapp.genCompid)(__prefix + "$compid__82"),
          _genCompid16 = _slicedToArray(_genCompid15, 2),
          $prevCompid__82 = _genCompid16[0],
          $compid__82 = _genCompid16[1];
