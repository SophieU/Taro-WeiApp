...
var Mine = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Mine() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Mine.__proto__ || Object.getPrototypeOf(Mine)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "$compid__643", "$compid__644", "$compid__645", "$compid__646", "$compid__647", "$compid__648", "$compid__649", "$compid__650", "withdrawMoney", "withdrawPwdForm", "withdrawPwd", "showModal", "showModalPwd", "wallet", "pageSize", "pageNo", "current", "hasNextPage", "hasNextPageWith", "pageSizeWith", "pageNoWith", "flowLists", "withdrawLists"], _this.config = {
      navigationBarTitleText: '我的钱包',
      navigationStyle: 'default'
    }, _this.getInfo = function () {
      _taroWeapp2.default.showLoading({ title: '' });
      ...
      (0, _pocketApi.startWithdraw)(params).then(function (res) {
        if (res.data.code === 0) {
          ...
          _this.setState({
            ...
            _this.toggleModalStatus('widthdraw');
            _this.getInfo();
            _this.getFlow();
            _this.getWithDrawHistory();
          });
  ...
  _createClass(Mine, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroWeapp.genCompid)(__prefix + "$compid__643"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__643 = _genCompid2[0],
          $compid__643 = _genCompid2[1];

      var _genCompid3 = (0, _taroWeapp.genCompid)(__prefix + "$compid__644"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__644 = _genCompid4[0],
          $compid__644 = _genCompid4[1];

      var _genCompid5 = (0, _taroWeapp.genCompid)(__prefix + "$compid__645"),
          _genCompid6 = _slicedToArray(_genCompid5, 2),
          $prevCompid__645 = _genCompid6[0],
          $compid__645 = _genCompid6[1];

      var _genCompid7 = (0, _taroWeapp.genCompid)(__prefix + "$compid__646"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__646 = _genCompid8[0],
          $compid__646 = _genCompid8[1];

      var _genCompid9 = (0, _taroWeapp.genCompid)(__prefix + "$compid__647"),
          _genCompid10 = _slicedToArray(_genCompid9, 2),
          $prevCompid__647 = _genCompid10[0],
          $compid__647 = _genCompid10[1];

      var _genCompid11 = (0, _taroWeapp.genCompid)(__prefix + "$compid__648"),
          _genCompid12 = _slicedToArray(_genCompid11, 2),
          $prevCompid__648 = _genCompid12[0],
          $compid__648 = _genCompid12[1];

      var _genCompid13 = (0, _taroWeapp.genCompid)(__prefix + "$compid__649"),
          _genCompid14 = _slicedToArray(_genCompid13, 2),
          $prevCompid__649 = _genCompid14[0],
          $compid__649 = _genCompid14[1];

      var _genCompid15 = (0, _taroWeapp.genCompid)(__prefix + "$compid__650"),
          _genCompid16 = _slicedToArray(_genCompid15, 2),
          $prevCompid__650 = _genCompid16[0],
          $compid__650 = _genCompid16[1];
      ...
      }, $compid__643, $prevCompid__643);
      _taroWeapp.propsManager.set({
        "current": this.__state.current,
        "index": 0
      }, $compid__644, $prevCompid__644);
      _taroWeapp.propsManager.set({
        "current": this.__state.current,
        "index": 1
      }, $compid__645, $prevCompid__645);
      _taroWeapp.propsManager.set({
        "closeOnClickOverlay": false,
        "className": "pwd-modal",
        "isOpened": this.__state.showModalPwd
      }, $compid__646, $prevCompid__646);
      _taroWeapp.propsManager.set({
        "name": "withdrawPwd",
        "type": "password",
      ...
      }, $compid__647, $prevCompid__647);
      _taroWeapp.propsManager.set({
        "className": "withdraw-modal",
        "isOpened": this.__state.showModal
      }, $compid__648, $prevCompid__648);
      _taroWeapp.propsManager.set({
        "name": "withdrawMoney",
        "title": '\u91D1\u989D',
        "type": "number",
      ...
      Object.assign(this.__state, {
        ...
        $compid__643: $compid__643,
        $compid__644: $compid__644,
        $compid__645: $compid__645,
        $compid__646: $compid__646,
        $compid__647: $compid__647,
        $compid__648: $compid__648,
        $compid__649: $compid__649,
  ...
  return Mine;
}(_taroWeapp.Component), _class.$$events = ["scrollToBottom", "handleWithdrawBtn", "anonymousFunc0", "handlePwd", "anonymousFunc3", "handleWithdraw"], _class.$$componentPath = "pages/mine/pocket", _temp2);
