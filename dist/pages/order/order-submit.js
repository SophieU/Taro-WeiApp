...
var OrderSubmit = (_temp2 = _class = function (_BaseComponent) {
  ...
  function OrderSubmit() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = OrderSubmit.__proto__ || Object.getPrototypeOf(OrderSubmit)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "anonymousState__temp3", "anonymousState__temp4", "anonymousState__temp5", "anonymousState__temp6", "anonymousState__temp7", "anonymousState__temp8", "anonymousState__temp9", "anonymousState__temp10", "loopArray112", "$compid__318", "$compid__319", "$compid__320", "$compid__321", "$compid__322", "bannerLists", "current", "repairCategoryId", "repairUserAddressId", "repairUserAddressObj", "address", "userName", "userMobile", "faultReason", "otherTips", "serviceFeeTips", "serviceTimeTips", "nightFee", "repairOrderOfferPlanDtoList", "timer", "serviceContent", "appStore"], _this.config = {
  ...
  _createClass(OrderSubmit, [{
    ...
    value: function _createData() {
      ...
      var loopArray112 = this.__state.bannerLists.length > 0 ? this.__state.bannerLists.map(function (item, __index0) {
        item = {
