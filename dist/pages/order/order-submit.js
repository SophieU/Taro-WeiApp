...
var OrderSubmit = (_temp2 = _class = function (_BaseComponent) {
  ...
  function OrderSubmit() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = OrderSubmit.__proto__ || Object.getPrototypeOf(OrderSubmit)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "anonymousState__temp3", "anonymousState__temp4", "anonymousState__temp5", "anonymousState__temp6", "anonymousState__temp7", "anonymousState__temp8", "anonymousState__temp9", "loopArray58", "$compid__68", "$compid__69", "$compid__70", "$compid__71", "$compid__72", "bannerLists", "current", "repairCategoryId", "repairUserAddressId", "repairUserAddressObj", "address", "userMobile", "faultReason", "otherTips", "serviceFeeTips", "serviceTimeTips", "nightFee", "repairOrderOfferPlanDtoList", "serviceContent", "appStore"], _this.config = {
      ...
      var params = {
        ...
        username: _this.state.repairUserAddressObj.userName,
        repairCategoryId: _this.state.repairCategoryId,
    ...
    }, _this.handleInputMobile = function (e) {
  ...
  _createClass(OrderSubmit, [{
    ...
    value: function _createData() {
      ...
      var anonymousState__temp4 = __webpack_require__(/*! ../../assets/imgs/tmp/img_cash.png */ "./src/assets/imgs/tmp/img_cash.png");
      ...
      var anonymousState__temp9 = [{ title: '服务说明' }, { title: '服务时间' }, { title: '服务费用' }, { title: '其他' }];
      var loopArray58 = this.__state.bannerLists.length > 0 ? this.__state.bannerLists.map(function (item, __index0) {
        item = {
  ...
  return OrderSubmit;
}(_taroWeapp.Component), _class.$$events = ["anonymousFunc0", "handleInputMobile", "handleInputReason", "submitForm"], _class.$$componentPath = "pages/order/order-submit", _temp2);
