...
var Lists = (_temp2 = _class = function (_BaseComponent) {
  ...
  _createClass(Lists, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroWeapp.genCompid)(__prefix + "$compid__527"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__527 = _genCompid2[0],
          $compid__527 = _genCompid2[1];

      var _genCompid3 = (0, _taroWeapp.genCompid)(__prefix + "$compid__528"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__528 = _genCompid4[0],
          $compid__528 = _genCompid4[1];

      var _genCompid5 = (0, _taroWeapp.genCompid)(__prefix + "$compid__529"),
          _genCompid6 = _slicedToArray(_genCompid5, 2),
          $prevCompid__529 = _genCompid6[0],
          $compid__529 = _genCompid6[1];

      var _genCompid7 = (0, _taroWeapp.genCompid)(__prefix + "$compid__530"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__530 = _genCompid8[0],
          $compid__530 = _genCompid8[1];

      var stateText = this.__state.baseInfo.orderStateName;

      var anonymousState__temp = this._createFootData(__prefix + "caczzzzzzz")();
