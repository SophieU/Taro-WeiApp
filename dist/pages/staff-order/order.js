...
var Lists = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Lists() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Lists.__proto__ || Object.getPrototypeOf(Lists)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__67", "current", "pageNo", "pageSize", "hasNextPage", "repairOrderState", "lists", "orderStateOptions"], _this.config = {
