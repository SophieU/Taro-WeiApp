...
var Quote = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Quote() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Quote.__proto__ || Object.getPrototypeOf(Quote)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray52", "staffPrice", "id", "type", "doorFee", "nightFee", "servicePrice", "materialsPrice", "totalAmount", "repairOrderOfferPlanVoList", "dispatchId", "finalAmount"], _this.config = {
  ...
  _createClass(Quote, [{
    ...
    value: function _createData() {
      ...
      var loopArray52 = this.__state.repairOrderOfferPlanVoList.map(function (item, _anonIdx) {
        item = {
