    ...
    return (<View className='page detail-page'>
      ...
      <View className='page-foot'>
        <View className='price-total'>
          <Text className='text-grey'>总计：</Text>
          <Text className='text-warm'>￥60.00</Text>
        </View>
        <View>
          {false?(<Block><Button className='btn default-btn'>重新报价</Button>
            <Button className='btn primary-btn'>确认</Button></Block>):null}
          {true?(<Block><Button className='btn default-btn'>用户端支付</Button>
            <Button className='btn primary-btn'>二维码收款</Button></Block>):null}
        </View>
       </View>
    </View>)
  }
